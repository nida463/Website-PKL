...
const Sektoral = () => {
  ...
  const handleOPDChange = async (e) => {
    ...
    setSelectedUrusan(""); // Reset urusan saat OPD diubah
    setLoading(true);
  ...
  const handleSearch = async (e) => {
    ...
    setLoading(true);
    setDataHasil([]); // Reset data hasil pencarian
  ...
  const handlePageChange = (pageNumber) => {
    ...
    handleSearch(); // Memanggil handleSearch untuk mendapatkan data sesuai dengan halaman
  };
