...
const Sektoral = () => {
  ...
  // Menghandle perubahan halaman
  const handlePageChange = (page) => {
    setCurrentPage(page);
  };

  // Menghandle perubahan jumlah data per halaman
  const handleItemsPerPageChange = (e) => {
    setItemsPerPage(Number(e.target.value));
    setCurrentPage(1); // Reset ke halaman pertama setiap kali jumlah per halaman berubah
  };

  // Mendapatkan data yang akan ditampilkan berdasarkan pagination
