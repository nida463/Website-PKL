...
const Sektoral = () => {
  ...
  const [totalData, setTotalData] = useState(0); // Total data sesuai dari API
  ...
  const handleSearch = async (page = 1) => {
    ...
    try {
      ...
      setTotalData(totalItems ? parseInt(totalItems, 10) : 0); // Simpan total data
      setError(null);
    } catch (error) {
  ...
  const totalPages = Math.ceil(totalData / itemsPerPage); // Hitung total halaman
      ...
      <div className="sektoral-box">
        ...
        {loading ? (
          ...
          <div className="sektoral-results">
            ...
            <p>Total Data: {totalData}</p> {/* Tampilkan total data */}
