...
const Sektoral = () => {
  ...
  const handleSearch = async (e) => {
    ...
    setLoading(true);
    setDataHasil([]); // Kosongkan data hasil sebelum pencarian baru
  ...
  const handlePageChange = (pageNumber) => {
    ...
    setDataHasil([]); // Kosongkan data hasil sebelum memuat halaman baru
    handleSearch({ preventDefault: () => {} }); // Simulasi preventDefault
  };
