...
const Sektoral = () => {
  ...
  const handleOPDChange = async (selectedOption) => {
    ...
    if (selectedOption) {
      try {
        ...
        setError(null);
        // Panggil pencarian setelah OPD dipilih
        handleSearch(); // Memanggil pencarian setelah memilih OPD
      } catch (error) {
  ...
  const handleUrusanChange = (selectedOption) => {
    setSelectedUrusan(selectedOption);
    // Panggil pencarian setelah Urusan dipilih
    handleSearch(); // Memanggil pencarian setelah memilih Urusan
  };
      ...
      <div className="sektoral-box">
        ...
        >
          ...
          <Select
            ...
            onChange={handleUrusanChange} // Memanggil fungsi baru di sini
            options={urusans}
